...
function Login() {
  return (
    <div className="h-screen flex bg-white justify-center items-center">
      <div className="loginContainer border-2 flex justify-center items-center h-70 border-black">
        ...
        <div className="login-section bg-neutral-100 h-4/5 w-3/4 p-3 card mr-5 leading-loose px-6">
          <div className="login-header-section py-2">
            <h1 className="text-4xl text-center font-semi-bold">Login</h1>
            <span ><p className="text-align text-center">Sign in to continue</p></span>
          </div>
          <form action="/">
            <div className="form-control w-full max-w-xs">
              ...
              <button className="btn btn-primary text-white mt-4 text-xl">LOGIN</button>
            </div>
           
          </form>
          <span><p>Not a member? <a href="#" className="link-info">Sign Up</a></p></span>
        </div>
      </div>
    </div>
  );
